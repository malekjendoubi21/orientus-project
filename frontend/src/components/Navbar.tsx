      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <Link to="/recommendations" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-2 px-4 py-2 text-gray-700 hover:bg-blue-50 rounded-lg font-medium">
